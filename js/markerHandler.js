...
AFRAME.registerComponent("markerhandler", {
  ...
  askTableNumber: function() {
    ...
    swal({
      ...
      content : {
        element : 'input',
        attributes : {placeholder : 'Type your table number', type : 'number', min : 1}
      },
  ...
  handleMarkerFound: function(dishes, markerId) {
    ...
    if (dish.unavailable_days.includes(days[todaysDay])) {
      ...
      var pricePlaneContainer = document.querySelector(`#price-plane-${dish.id}`)
    ...
    .then(doc=>{
      ...
      if(details['current_orders'][dish.id]){
        ...
        details['current_orders'][dish.id] = {
          item : dish.dish_name, price: dish.price, quantity : 1, subtotal :dish.price
        }
      }
